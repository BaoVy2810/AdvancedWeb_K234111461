...
@Component({
  selector: 'app-ex58-admin-fashiondetail',
  standalone: false,
  templateUrl: './ex58-admin-fashiondetail.html',
  styleUrl: './ex58-admin-fashiondetail.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
})
export class Ex58AdminFashiondetail implements OnInit {
